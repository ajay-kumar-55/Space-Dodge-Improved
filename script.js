...
const difficultySettings = {
  easy: {
    moveSpeed: 11, // Slow speed
    spawnRate: 35, // Spawn asteroid every 70 frames
    starSpeedMultiplier: 2.0, // Normal star speed
    name: "EASY",
  },
  medium: {
    moveSpeed: 10, // Medium speed
    spawnRate: 25, // Spawn asteroid every 45 frames (more asteroids)
    starSpeedMultiplier: 2.5, // 1.5x star speed
    name: "MEDIUM",
  },
  hard: {
    moveSpeed: 20, // Fast speed
    spawnRate: 15, // Spawn asteroid every 30 frames (lots of asteroids!)
    starSpeedMultiplier: 4.5, // 2.2x star speed
    name: "HARD",
  },
};
